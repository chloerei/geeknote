...
class SessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should sign in with email password" do
    ...
    post sessions_path, params: { email: 'username@example.com', password: 'password' }, xhr: true
  ...
  test "should not sign in with wrong password" do
    user = create(:user, email: 'username@example.com', password: 'password')
    post sessions_path, params: { email: 'username@example.com', password: 'wrong' }, xhr: true
