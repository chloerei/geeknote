...
class Identity::Email::UnsubscribesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get show page with token" do
    user = create(:user)
    get identity_email_unsubscribe_path(token: user.generate_token_for(:email_unsubscription), type: "comment")
  ...
  test "should unsubscribe comment email" do
    ...
    patch identity_email_unsubscribe_path(token: user.generate_token_for(:email_unsubscription), type: "comment")
    assert_response :success
    user.reload
  ...
  test "should unsubscribe weekly summary email" do
    ...
    patch identity_email_unsubscribe_path(token: user.generate_token_for(:email_unsubscription), type: "weekly_digest")
    assert_response :success
    user.reload
